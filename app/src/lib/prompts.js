...
export const buildRecommendPrompt = (trained, untrained) =>
  `Du er en personlig trener. Brukeren har trent disse musklene i dag: ${trained.join(", ")}.
...
export const buildPeriodRecommendPrompt = (periodDays, sessionCount, trainedLabels, untrainedLabels) =>
  `Du er en personlig trener som analyserer en klients treningshistorikk fra de siste ${periodDays} dagene (${sessionCount} økter).
